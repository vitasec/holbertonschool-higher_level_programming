...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Args:
            size (int): Kvadratın tərəfinin uzunluğu. Standart 0.
    ...
    def my_print(self):
        ...
        # my_print artıq sadəcə obyektin özünü çap edir
        print(self)

    def __str__(self):
        """Kvadratın çap ediləcək sətir (string) versiyasını qaytarır."""
        if self.__size == 0:
            return ""
        ...
        # Siyahıdakı bütün sətirləri "yeni sətir" (\n) simvolu ilə birləşdirir
        return "\n".join(lines)
